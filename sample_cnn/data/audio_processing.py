...
def _segments_to_sequence_example(segments, labels):
  ...
  feature_lists = tf.train.FeatureLists(feature_list={
    # list of float32 Tensor (59049,)
    'raw_segments': _bytes_feature_list(raw_segments)
  })
...
def audio_to_sequence_example(filename, labels, sample_rate, n_samples):
  ...
  Returns:
    A SequenceExample proto.
  """
  segments = _audio_to_segments(filename,
...
def audio_to_examples(filename, labels, sample_rate, n_samples):
